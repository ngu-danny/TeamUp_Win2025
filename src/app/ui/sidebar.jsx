  ...
  return (
    <div className="flex flex-col sticky text-center bg-app-theme text-app-inverse h-screen w-[5rem] min-w-[5rem] z-[100] overflow-hidden">
      ...
      <Link href="/settings">
        ...
        <button className="sidebar-button" disabled={pathname === "/settings"}>
          <SettingsIcon
            height="1.5625rem"
            width="1.5625rem"
            fill={`${
      ...
      <Link href="/profile">
        ...
        <button className="sidebar-button" disabled={pathname === "/profile"}>
          <AccountIcon
            height="1.5625rem"
            width="1.5625rem"
            fill={`${
      ...
      <button
        ...
        onClick={() => router.push(`/logged-out/login`)}
      >
        <LogoutIcon
          height="1.5625rem"
          width="1.5625rem"
